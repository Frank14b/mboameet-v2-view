      ...
      <div className="w-full mt-6">
        <ul className="flex flex-col w-full">
          <li className="relative flex flex-col gap-2">
            ...
            <div className="relative flex items-center gap-4 py-3 pl-4 pr-8 bg-white dark:bg-black/35 dark:border-0 border shadow-lg rounded-0 border-blue-gray-50 shadow-blue-gray-900/5">
