      ...
      <div className="flex items-center justify-center w-full">
        <label
          ...
          className={`flex flex-col items-center justify-center w-full h-64 border-2 
                ...
                ${errorFound ? "border-red-600" : "border-gray-300 dark:border-gray-600"}`}
        >
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className={`mb-2 ${errorFound ? "text-red-600" : "text-gray-500 dark:text-gray-400"} text-sm`}>
              <span className="font-semibold">Click to upload</span> or drag and
              drop
            </p>
            <p className={`text-xs ${errorFound ? "text-red-600" : "text-gray-500 dark:text-gray-400"}`}>
