        ...
        <Menu>
            <MenuHandler>
                ...
                <Avatar
                    ...
                    variant="circular"
                    alt="tania andrew"
                    src={`${process.env.NEXT_PUBLIC_API_PUBLIC_FILES_LINK}${mainContext.connectedUser?.id}/${mainContext.connectedUser?.photo ?? defaultProfileImg}`}
                ></Avatar>
                <Typography
                    placeholder={""}
                    className="text-lg font-bold text-gray-900 dark:text-gray-100"
                >{ mainContext.connectedUser?.userName } </Typography>
            ...
            <MenuList placeholder={""}>
                ...
                <MenuItem placeholder={""} className="flex items-center gap-2 " onClick={() => mainContext.logout()}>
                    <svg
                        width="16"
                        height="14"
                        viewBox="0 0 16 14"
